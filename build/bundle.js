...
var _adminPage = __webpack_require__(23);
...
var HomePage = function HomePage() {
    var makeRequest = function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            var respone_with_proxy, response_without_proxy;
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                        ...
                        case 2:
                            respone_with_proxy = _context.sent;
                            _context.next = 5;
                            return _axios2.default.get("http://react-ssr-api.herokuapp.com/current_user");

                        case 5:
                            response_without_proxy = _context.sent;


                            console.log({ respone_with_proxy: respone_with_proxy, response_without_proxy: response_without_proxy });
